				...
				<TabsContent value='overview' className='space-y-10'>
					...
					<div className='text-center space-y-8 py-8'>
						...
						<div className='flex justify-center gap-6'>
							<Button
								onClick={() => {
									const scrapingTab = document.querySelector(
										'[value="scraping"]'
									) as HTMLElement;
									if (scrapingTab) scrapingTab.click();
								}}
								className='bg-blue-600 hover:bg-blue-700 text-white font-semibold px-10 py-4 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 text-lg'>
								...
								<Link href='/dashboard/search'>
									<div className='p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border-2 border-blue-200 hover:shadow-xl transition-all duration-300 cursor-pointer group transform hover:-translate-y-2'>
										...
										<p className='text-blue-700 text-lg mb-6 leading-relaxed'>
											Search across multiple crowdfunding platforms with
							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
								...
								<div className='flex items-start gap-6'>
									...
									<div>
										...
										<p className='text-amber-700 text-base leading-relaxed'>
											Seamlessly export your findings to Google Sheets for
								...
								<div className='flex items-start gap-6'>
									...
									<div>
										...
										<p className='text-amber-700 text-base leading-relaxed'>
											Monitor project success rates and funding patterns to
