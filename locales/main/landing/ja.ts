const ja = {
  hero: {
    badge: "AI搭載クラウドファンディング分析プラットフォーム",
    title: "9以上のクラウドファンディングプラットフォームからリアルデータを抽出",
    subtitle: "OCR/NLP強化による高度なウェブスクレイピング。Kickstarter、Indiegogo、Makuake、WadizなどからAIによる高精度なデータ抽出と自動エクスポート。",
  },
  features: {
    badge: "実際のプラットフォーム機能",
    title: "私たちが実際に提供するもの",
    subtitle: "AI強化と自動化ワークフローによる包括的なクラウドファンディングデータ抽出",
    cards: [
      {
  ...
  pricing: {
    title: "シンプルな価格設定",
    subtitle: "ご利用目的に合わせて最適なプランをお選びください。すべてのプランに主要なスクレイピングとAI強化機能が含まれます。",
    plans: [
      {
        name: "スターター",
        price: "$29",
  ...
  stats: {
    title: "プラットフォーム統計",
    subtitle: "包括的なクラウドファンディング分析プラットフォームのリアルタイムデータ",
  ...
  testimonials: {
    ...
    subtitle: "数千人のプロフェッショナルがCrowdFund Proをリサーチ・分析に活用しています",
    trust: [
  ...
  cta: {
    ...
    subtitle: "多くの研究者や企業がAI搭載プラットフォームを信頼し、包括的なクラウドファンディング分析に活用しています。",
    startTrial: "無料トライアルを始める",
    contactSales: "お問い合わせ"
  },
  footer: {
    companyDesc: "AI搭載OCR/NLP強化による高度なクラウドファンディング分析プラットフォーム。9以上のグローバルプラットフォームから包括的なデータを自動エクスポートで抽出。",
    featuresTitle: "プラットフォーム機能",
    features: ["AI OCR強化", "マルチプラットフォームスクレイピング", "自動エクスポート", "データセキュリティ"],
