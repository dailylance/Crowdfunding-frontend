					...
					<CardContent>
						<div className='space-y-2'>
							...
							<p className='text-3xl font-bold text-orange-900'>
								{Math.round(
									(analyticsData.successfulProjects /
										analyticsData.totalSaved) *
										100
								)}
								%
						...
						<div className='space-y-4'>
							{analyticsData.weeklySearches.map((day, index) => {
								const maxCount = Math.max(
									...analyticsData.weeklySearches.map((d) => d.count)
								);
								...
								<div
									...
									<div className='space-y-2'>
										...
										<div className='flex justify-between text-sm'>
											...
											<span
												className={`font-bold ${getSuccessTextColor(
										...
										<div className='w-full bg-gray-200 rounded-full h-2'>
											<div
												className={`h-full bg-gradient-to-r ${getSuccessColor(
													category.success_rate
												)} rounded-full transition-all duration-300`}
			...
			<Card className='shadow-lg border-0'>
				...
				<CardContent>
					<div className='space-y-4'>
						{[
							{
								action: "Searched for 'smart home devices' on Kickstarter",
								time: "2 hours ago",
								type: "search",
							},
							{
								action: "Saved project 'Eco-Friendly Water Bottle'",
								time: "4 hours ago",
								type: "save",
							},
							{
								action: "Exported data to Google Sheets",
								time: "6 hours ago",
								type: "export",
							},
							{
								action: "Discovered trending project in Technology",
								time: "1 day ago",
								type: "discovery",
							},
						].map((activity, index) => (
